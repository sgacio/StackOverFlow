...
export const SpecificQuestion = (props) => {
    ...
    const getQuestion = async () => {
        await axios.get(`https://localhost:5001/api/Question/question/${props.match.params.id}`)
            .then(res => {
    ...
    const getAnswers = async () => {
        await axios.get(`https://localhost:5001/api/Question/AllAnswersJoin/${props.match.params.id}`)
            .then(res => {
                console.log(res)
                setAnswers(res.data)
            })
